...
#ifndef __FILE__  // because warning: "__FILE__" redefined
...
// some trivial test invocations, can get compiled to create a single FAILED or
// to create all PASS test results
